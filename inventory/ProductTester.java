...
public class ProductTester 
{
	public static void main(String[] args)
	{
		...
		{
			Product[] products=new Product[maxSize]; in.nextLine(); addToInventory(products,in);
		    do 
		    {
		    	menuChoice=getMenuOption(in); executeMenuChoice(menuChoice,products,in);
		    }while(menuChoice!=0);
		}
	}
    ...
    public static void addToInventory(Product[] products,Scanner in)
    {
        ...
        do
        {
        	try 
        	{
        		stockChoice=in.nextInt(); if(stockChoice<1 || stockChoice>2)
        		{
        ...
        case 1:CD.addCDToInventory(products,in);
                break;
        case 2:DVD.addDVDToInventory(products,in); break;
        }
    }
    ...
    public static void executeMenuChoice(int menuChoice,Product products[],Scanner in)
    {
    	switch(menuChoice)
    	{
    	case 1:displayInventory(products); break;
        case 2:addStock(products,in);break;
        case 3:deductStock(products,in);break;
    ...
    public static int getNumProducts(Scanner in)
    {
        ...
        do
        {
        	...
        	{
        		System.out.println("Incorrect Datatype Entered"); in.nextLine();
                maxSize=-1;
            }
        }while(maxSize<0); 
        return maxSize;
