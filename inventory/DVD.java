...
public class DVD extends Product
{
    ...
    {
    	super(number,name,qty,price); this.ageRating=rating; this.FilmStudio=Fstudio; this.lenInMin=length;
    }
    ...
    public static void addDVDToInventory(Product[] dvds,Scanner in)
    {
        ...
        {
        	System.out.println("Enter The Name of the DVD:"); tempName=in.next();
            System.out.println("Enter The Quantity of the DVD's:"); tempQty=in.nextInt();
            in.nextLine();//buffer
            System.out.println("Enter The Price of the DVD:"); tempPrice=in.nextInt();
            in.nextLine();//buffer
            System.out.println("Enter The Item Number of the DVD:"); tempNumber=in.nextInt();
            in.nextLine();//buffer
            System.out.println("Enter Length of Movie in the DVD:"); templenInMin=in.nextInt();
            in.nextLine();//buffer
            System.out.println("Enter The Age Rating of the movie in DVD:"); tempageRating=in.nextInt();
            in.nextLine();//buffer
            System.out.println("Enter The Film Studio of the Movie:"); tempFilmStudio=in.next();
            //products[i]=new Product(tempNumber,tempName,tempQty,tempPrice);
            dvds[i]=new 
            DVD(tempNumber,tempName,tempQty,tempPrice,templenInMin,tempageRating,tempFilmStudio);
        }
    }
}
